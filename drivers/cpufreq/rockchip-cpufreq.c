...
/* Vendor-only SOC detection functions not in mainline */
static inline bool soc_is_rk3288(void) { return false; }
static inline bool soc_is_rk3288w(void) { return false; }
